...
- [Castleday Retreats](https://castledayretreats.com) — Bywater villas, up to 30 guests each, large common areas and private pools ideal for villa-based welcome receptions, complete privacy
- [The Syd](https://thesyd.com) — Lower Garden District villas, up to 22 guests, outdoor kitchen and shared pool purpose-built for catered group gatherings, one block from St. Charles Streetcar
