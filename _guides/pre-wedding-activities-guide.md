...
A prix-fixe dinner in a private room, open bar during cocktail hour, a few toasts. Two to two-and-a-half hours total. This is long enough for meaningful toasts and short enough that nobody is exhausted for the next day.
...
- [Castleday Retreats](https://castledayretreats.com) — Bywater, three private villas up to 30 guests, private pools, full kitchens, art-filled interiors
- [The Syd](https://thesyd.com) — Lower Garden District, up to 22 guests per villa, shared pool, hot tub, sauna, one block from the streetcar
