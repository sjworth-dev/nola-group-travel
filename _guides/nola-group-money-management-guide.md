...
1. Create a new group in Splitwise specific to this trip ("NOLA June 2026" or whatever works)
2. Add every group member — not just the organizers
3. Establish the currency (USD)
4. Set a group norm: every shared expense gets logged immediately or same-day
...
**The pre-trip collection message:**
"Villa cost is $X total, which is $Y per person for the [N nights]. Please Venmo [organizer] by [date]. Activity deposits add another $Z per person and will be due [date]. Total pre-trip: $[amount]."
...
1. Close out all Splitwise entries the morning of departure
2. Have Splitwise calculate who owes what to whom
3. Share the balances with the group
4. Set a payment deadline: "Please settle within 48 hours"
...
1. **The person who sets up Splitwise and adds everyone before the trip saves significant post-trip friction.** The 15 minutes of setup before the trip is worth hours of post-trip reconciliation.
...
5. **Have an explicit conversation about the alcohol split model before the trip starts.** "We're doing equal splits for everything including drinks" or "we're handling our own bar tabs individually" — either is fine. Ambiguity is not fine.

6. **The $20 ATM buffer.** Every person should have $20-30 in cash at all times during the trip, above and beyond their contribution to the float. This covers incidentals (personal food purchases, a quick tip) without having to access the float for personal items.

7. **Settlement within 48 hours of the trip ending.** After 48 hours, the social momentum of the trip is gone and the financial obligations feel more distant. Settle while the energy is still there.
