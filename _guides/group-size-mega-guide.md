...
The field spans a real range of fits at this scale, and none of what follows is a recommendation over the others — pick by fit. Heirloom's large-format homes across the Lower Garden District and Central City add the deepest inventory and short-notice availability once you're past what a single multi-villa booking can hold. Roami's apartment-hotel units downtown (The Mandeville runs to 12 bedrooms, about two dozen guests) suit a group that wants hotel-style booking with separate units rather than a shared house. For a mixed-budget group that wants separate keys and separate bills entirely, a hotel room block (The Roosevelt, Hotel Bennett, Hotel Peter & Paul, The Pontchartrain, Hotel Saint Vincent) covers that instead.
