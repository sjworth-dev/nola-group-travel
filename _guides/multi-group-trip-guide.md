...
Bywater villas built as separate structures on one property mean night-owl energy doesn't bleed into bedrooms where early risers are sleeping — a real advantage for the hub-and-spoke model specifically. The Revelry, in Central City, runs the opposite shape: apartment-style floors around a shared saltwater pool that becomes a natural cross-sub-group gathering point without anyone having to organize it. Both shapes fit the model; which one fits depends on whether you want separated structures or a shared social center.
