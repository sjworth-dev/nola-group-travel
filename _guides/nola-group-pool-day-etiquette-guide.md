...
**The pool deck layout:**
Move the chairs and loungers before the day starts to create a setup that works for your actual group. If twelve people are using the pool and eight are lounging, configure the furniture accordingly. Default villa setups are rarely optimal for twenty people.
