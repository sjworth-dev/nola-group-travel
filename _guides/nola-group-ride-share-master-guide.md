---
title: "Uber for Large Groups in New Orleans: The Master Guide"
description: "Rideshare math, surge windows, airport pickup strategy, and when to ditch the apps for a charter van. The complete rideshare guide for groups of 10-30 in New Orleans."
...
Assign the transport coordinator before you arrive. It's one of the five [key trip roles](/guides/nola-group-trip-roles-assignment-guide/) that make or break a large group trip. Give them the charter van contact number at the start of the trip. They'll probably use it at least once.
