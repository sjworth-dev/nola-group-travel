...
1. Tell your group before you sit down: "This restaurant adds 18% automatically. Do not add more unless the service was exceptional."

2. Scan the bill before it goes to the table. Find the auto-grat line. Point it out.

3. The additional tip line on the receipt is meant for supplemental tips if you want to go above the auto-grat. Leaving it blank is completely normal and expected.
...
**At private villas:** Different structure than hotels. There's typically no daily housekeeping staff. Cleaning is handled on checkout.
...
1. **Tell your group about auto-grat before the first dinner.** Not at the table when the bill comes. Before.

2. **Designate the payer before you sit down.** Not when the check arrives. Before you order.

3. **Never tip the auto-grat amount in cash on top of a card payment.** This doesn't help the server—it's confusing and often gets returned.

4. **Carry some cash.** Street musicians, emergency tip moments, the walk-up window at Café Du Monde, parking attendants. NOLA is more cash-friendly than most cities.

5. **The person who complained about service the most should tip the most.** If you made the server's job harder with substitutions and special requests, don't be the person who tips least.

6. **When in doubt, round up.** Servers are skilled professionals, cost of living is real, and a group of 20 is a significant request of any restaurant.

7. **Tip in the context of the effort, not just the check size.** A bartender who made 12 Ramos Gin Fizzes worked harder than the check total reflects.
...
**Editorial examples of what fits:** private-pool Bywater villas (like Castleday Retreats) put the whole crew under one roof with a full kitchen, so shared costs — groceries, the bar cart, a private chef — run through one tab instead of a dozen personal cards. Heirloom's large-format homes across the Lower Garden District and Central City work the same way for groups that want deeper inventory or a short-notice booking. A hotel room block gives mixed-budget groups the option of separate bills and separate keys instead. None of these is a booking recommendation — pick by fit.
