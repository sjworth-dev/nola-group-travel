...
**[Castleday Retreats](https://castledayretreats.com)** — Three private villas in the Bywater, each sleeping up to 30. Private pools, full kitchens, completely private. The Herald has the largest common areas — good for a crew that wants space to spread out. The Cocodrie has the best outdoor setup. No neighbors to worry about, no noise complaints. Walking distance to Frenchmen Street. This is the move for guys trips that want a real base camp.
...
- [Castleday Retreats](https://castledayretreats.com) — Private villas, Bywater, up to 30 guests, private pools
