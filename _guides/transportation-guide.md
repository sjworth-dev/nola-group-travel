---
title: "Getting Around New Orleans With a Group"
description: "Streetcars, rideshares, walking, and the airport run — how a big group moves around New Orleans without losing anyone, with real costs and times."
...
1. Pre-order rideshare for fixed-time events (airport departures, dinner reservations) rather than ordering on the fly
...
1. **Walk during the day, rideshare at night.** Daytime walks are pleasant and free. Post-midnight, getting a group of 20 home is worth the Uber math.

2. **One person manages group transportation.** Designate them before the trip, not in the moment.

3. **Never try to cross an active parade route.** Wait for the float gap or go around.

4. **Get on the streetcar at least once.** The St. Charles line is a genuine New Orleans experience. Do it on a weekday afternoon when it's not crowded.

5. **Don't rent a car for the whole trip.** You won't use it. You'll pay to park it. Just don't.
