...
1. **Test every door and lock.** Exterior and interior. Know how they work before you need them at midnight.
2. **Locate the breaker box.** Know where it is. Something will trip.
3. **Find the water shutoff.** This is the thing nobody knows and everyone needs when a toilet runs or a pipe leaks.
4. **Check every appliance you plan to use.** TV works? WiFi password in hand? Pool controls?
5. **Document any existing damage.** Scratches on the table, a broken drawer, a missing shower head cover. Take photos. Send to property manager via text so you have a timestamp.
...
1. You can report it to the property manager in real time (sometimes it gets fixed)
2. You have a record if there's a dispute at checkout
...
1. Property manager finds it — they will often hold items for a period before disposing of them
2. Contact the property manager within 24 hours if you realize something is missing
3. For valuable items, ask about shipping — most property managers will ship for a fee
...
1. **The Group Lead role is worth compensating.** If one person handles all the logistics for 20 people, some form of acknowledgment is appropriate — whether that's a reduced share of the rental cost or just genuine recognition.

2. **Share key info before day-of, not at the curb.** Address, parking instructions, door code — these should be in a pinned group chat message two days before arrival.

3. **Checkout is a group activity.** The "I'll go wait in the Uber while you clean up" person is the group's most problematic member. Everyone contributes.

4. **15 minutes of cleanup per person is 4 hours of collective time.** It's not that hard. Assign it.

5. **Your property manager is your best resource.** If you have a question about checkout expectations, ask them directly before the day. "What does 'leave it clean' mean specifically?" is a completely reasonable question.

6. **Never leave key distribution until arrival day.** If the Group Lead has a delayed flight, the rest of the group is locked out.

7. **Take a group photo before everyone scatters at checkout.** It's chaos by departure — capture it earlier.
