...
- `_guides/nola-group-new-orleans-vs-scottsdale-guide.md` — targets "new orleans vs scottsdale bachelorette" / "new orleans vs scottsdale girls trip" — Scottsdale is the other major desert-Southwest bachelorette/girls-trip alternative (day-drinking pool-crawl scene) with no comparison page yet; cover pool-day-vs-live-music-city framing, lodging (resort/condo market vs. villa market), food and drink culture, and heat/season tradeoffs; category "Planning & Logistics"

- `_guides/nola-group-audubon-zoo-aquarium-guide.md` — targets "audubon zoo new orleans group tickets" / "new orleans aquarium group tour" — Audubon Zoo (Uptown) and the Aquarium of the Americas (riverfront) are real, bookable, NOLA-specific group attractions; currently only mentioned in passing as landmarks in `nola-riverfront-guide.md` and 7 other guides, with no dedicated page on group ticketing, membership vs. single-ticket math, the Insectarium add-on, or splitting a mixed-interest group between the two sites; category "Activities & Day Trips"

- `_guides/nola-group-new-orleans-vs-atlanta-guide.md` — targets "new orleans vs atlanta bachelorette" / "new orleans vs atlanta group trip" — same honest-comparison format as the existing Miami/Vegas/Nashville/Charleston/Memphis/Savannah/Austin guides; Atlanta is a major nearby Southern-hub alternative groups weigh against New Orleans (currently only namedropped as a flight-hub reference in 3 guides) with no comparison page yet; cover nightlife (upscale lounge/club scene vs. no-cover live-music model), lodging, food, and cost; category "Planning & Logistics"

- `_guides/nola-group-jazz-museum-guide.md` — targets "new orleans jazz museum group tour" / "old u.s. mint jazz museum group visit" — the New Orleans Jazz Museum at the Old U.S. Mint is a real, bookable group venue currently only mentioned as a one-line add-on in `nola-jazz-history-tour.md`'s expanded full-day itinerary, with no dedicated page on visiting the museum itself (exhibits, group tour format, pairing with the Tremé/Frenchmen Street music scene); write generally on format, defer current hours/pricing to official sources; category "Culture & History"
