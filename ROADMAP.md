...
- `_guides/nola-group-best-time-to-visit-guide.md` — targets "best time to visit new orleans for a group trip" / "best month to visit new orleans" — a major head-term query with no single dedicated page; the Seasonality ground truth (Oct and Feb–May peak, Jun–Aug and Jan soft, late Aug–mid-Sept as the real value window) is scattered across dozens of guides but never assembled into one standalone month-by-month reference for group organizers choosing dates; category "Planning & Logistics"

- `_guides/nola-group-new-orleans-vs-palm-springs-guide.md` — targets "new orleans vs palm springs bachelorette" / "new orleans vs palm springs girls trip" — Palm Springs is a common desert pool-club/day-drinking bachelorette alternative with zero existing mentions anywhere on the site and no comparison page; cover pool-day-vs-live-music-city framing, lodging (resort/mid-century rental market vs. villa market), food and drink culture, and the dry-desert-heat-vs-Gulf-humidity tradeoff; category "Planning & Logistics"

- `_guides/nola-group-new-orleans-vs-asheville-guide.md` — targets "new orleans vs asheville bachelorette" / "new orleans vs asheville girls trip" — Asheville is a common brewery-and-mountains bachelorette/girls-trip alternative; confirmed via grep that it's currently only a passing namedrop in `nola-group-dixie-beer-brewery-guide.md` with no comparison page; cover outdoor/brewery culture vs. live-music-city framing, lodging (mountain cabin/Airbnb market vs. villa market), food and drink culture, and climate (mild mountain vs. Gulf humidity); category "Planning & Logistics"

- `_guides/nola-group-hogs-for-the-cause-guide.md` — targets "hogs for the cause new orleans group" / "hogs for the cause tickets group" — Hogs for the Cause is a real, established March BBQ-competition-and-live-music charity festival at the UNO lakefront with zero existing mentions anywhere on the site and no dedicated page; cover format (BBQ teams, live music stages, the charity mission), logistics for a group (lakefront venue, getting there, ticket tiers), and how it fits the spring peak-season calendar per the Seasonality section; write generally on current-year specifics and defer dates/tickets/lineup to the official site; category "Festivals & Events"
