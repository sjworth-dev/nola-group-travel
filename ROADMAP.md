...
- `_guides/nola-group-new-orleans-vs-las-vegas-guide.md` — targets "new orleans vs vegas bachelorette" / "new orleans vs las vegas group trip" — same honest-comparison format as the existing Miami/Nashville/Charleston/Memphis/Savannah/Austin guides; Vegas is arguably the single most common bachelorette/big-birthday alternative group organizers weigh against New Orleans and it has no comparison page yet; cover nightlife structure (Strip club/table-service model vs. no-cover live-music model), lodging (Strip mega-resorts and condos vs. purpose-built villas), food, cost concentration, and the desert-heat-vs-Gulf-humidity angle; category "Planning & Logistics"
