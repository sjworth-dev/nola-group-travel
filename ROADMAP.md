...
- `_guides/nola-group-oyster-festival-guide.md` — targets "new orleans oyster festival group" / "louisiana oyster festival new orleans" — the (Louisiana) Oyster Festival is a real annual free festival on the riverfront near the French Quarter celebrating Gulf oysters — cooking demos, an oyster-eating/shucking contest, and food/craft vendors, typically landing in the early-summer soft-season window; a distinctive food-forward group anchor the site doesn't cover; write generally on format/the contest and defer current-year dates/vendors to official sources; checked `_guides/` — no dedicated page (only incidental mentions), category "Food & Drink"

- `_guides/nola-group-congo-square-rhythms-festival-guide.md` — targets "congo square rhythms festival new orleans group" / "congo square festival treme" — the Congo Square Rhythms Festival is a real annual free festival in Louis Armstrong Park's Congo Square built around African-diaspora music and cultural programming, distinct from the Treme Creole Gumbo Festival (food-focused, now published); typically lands in the spring high-demand window; a historically-grounded group anchor in a neighborhood the site undercovers; write generally on format/the historical significance of Congo Square and defer current-year lineup/dates to official sources; checked `_guides/` — no dedicated page, category "Festivals & Events"
