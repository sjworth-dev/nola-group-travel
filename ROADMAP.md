...
- `_guides/nola-group-buku-music-festival-guide.md` — targets "buku music festival new orleans group guide" / "buku fest new orleans group trip" — BUKU is a real annual New Orleans music festival (electronic/hip-hop-leaning, riverfront location near Mardi Gras World, generally held in March) that draws a younger festival-going crowd distinct from Jazz Fest's or French Quarter Fest's audience; write generally on timing/location and point to the official site for exact dates/lineup per the no-invented-specifics rule; checked `_guides/` — only one incidental mention (lgbtq-southern-decadence-guide.md), no dedicated page
- `_guides/nola-group-event-space-rental-guide.md` — targets "meeting space rental new orleans large group" / "corporate event venue new orleans" — venue types for a group that needs somewhere besides a restaurant or a villa living room (hotel ballrooms/meeting space, private event spaces in the Warehouse District/CBD, museum private rentals, restaurant private dining as event space), how this differs from just booking a room block, and when a villa's own space beats a rented venue; checked `_guides/` — corporate-retreat.md and corporate-team-building-guide.md mention venues only in passing, no dedicated treatment of the actual venue-rental decision
- `_guides/nola-group-tales-of-the-cocktail-guide.md` — targets "tales of the cocktail new orleans group guide" / "tales of the cocktail trip planning" — Tales of the Cocktail is a real, long-running annual New Orleans cocktail and spirits industry festival (generally held in July, CBD/Hotel Monteleone-area programming plus citywide bar events), drawing an industry/bar-crawl-minded crowd distinct from the site's other festival guides; write generally on timing/format and point to the official site for exact dates/programming per the no-invented-specifics rule; checked `_guides/` — no dedicated page or incidental mention exists
