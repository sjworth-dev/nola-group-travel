...
- `_guides/nola-group-wwii-museum-guide.md` — targets "national wwii museum new orleans group tour" / "wwii museum new orleans group tickets" — the National WWII Museum is a real, bookable, world-class Warehouse District attraction currently only mentioned in passing across 13+ guides (most heavily in `rainy-day-guide.md`, which calls it "one of the best museums in the United States"), with no dedicated page on group tour format, exhibit halls, timing, or group-rate booking; write generally on format, defer current hours/pricing to official sources; category "Activities & Day Trips"

- `_guides/nola-group-new-orleans-vs-key-west-guide.md` — targets "new orleans vs key west bachelorette" / "new orleans vs key west girls trip" — Key West is a common island/boat-and-day-drinking bachelorette alternative with zero existing mentions anywhere on the site and no comparison page; cover boat/water culture vs. live-music-city framing, lodging (resort/condo market vs. villa market), food and drink culture, and the shared hurricane-season risk window; category "Planning & Logistics"
