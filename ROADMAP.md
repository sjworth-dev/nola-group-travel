...
- `_guides/nola-group-creole-tomato-festival-guide.md` — targets "creole tomato festival new orleans group" / "creole tomato festival french market" — the Creole Tomato Festival is a real annual mid-June event at the French Market (farmers market, cooking demos), low-key and local per `_guides/festival-season-calendar.md` (currently only one bullet there); no dedicated page; a genuine soft-season (June) local-flavor anchor the site undercovers; write generally on format and defer current-year vendors/demo schedule/pricing to official sources; category "Food & Drink"

- `_guides/nola-group-fqf-vs-jazz-fest-guide.md` — targets "french quarter fest vs jazz fest" / "should we go to jazz fest or french quarter fest" — a distinct comparison query from the existing "Jazz Fest vs. Mardi Gras" section inside `jazz-fest-group-guide.md`; group organizers choosing between New Orleans' two biggest spring music festivals (FQF: free, all-local lineup, walkable French Quarter footprint; Jazz Fest: ticketed, national+local lineup, fairgrounds footprint) is a real, unaddressed decision point; write on format, cost, crowd size, and lineup-style differences, deferring current-year lineups/prices to official sources; category "Festivals & Events"
