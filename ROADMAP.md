...
- `_guides/nola-group-tennessee-williams-festival-guide.md` — targets "tennessee williams festival new orleans group" / "new orleans literary festival group trip" — the Tennessee Williams & New Orleans Literary Festival is a real annual late-March event (panels, master classes, walking tours, and the famous Stella-and-Stanley shouting contest in Jackson Square) that lands squarely in the spring high-demand stretch alongside Mardi Gras/FQF/Jazz Fest; a distinctive lower-key, culture-forward group anchor the site doesn't cover; write generally on format/the shouting contest tradition and defer current-year dates/programming to the official site; checked `_guides/` — no dedicated page, category "Culture & History"

- `_guides/nola-group-treme-gumbo-festival-guide.md` — targets "treme gumbo festival new orleans group" / "congo square gumbo festival" — the Treme Creole Gumbo Festival is a real free annual festival in Congo Square (Treme) built around a gumbo cook-off and Creole culture programming, typically landing in the spring high-demand window; a distinctive, historically-grounded, low-cost group anchor in a neighborhood the site undercovers; write generally on format/the cook-off and defer current-year dates/vendors to official sources; checked `_guides/` — no dedicated page, category "Food & Drink"
...
- `_guides/nola-group-congo-square-rhythms-festival-guide.md` — targets "congo square rhythms festival new orleans group" / "congo square festival treme" — the Congo Square Rhythms Festival is a real annual free festival in Louis Armstrong Park's Congo Square built around African-diaspora music and cultural programming, distinct from the nearby Treme Creole Gumbo Festival (food-focused) already in this backlog; typically lands in the spring high-demand window; a historically-grounded group anchor in a neighborhood the site undercovers; write generally on format/the historical significance of Congo Square and defer current-year lineup/dates to official sources; checked `_guides/` — no dedicated page, category "Festivals & Events"
