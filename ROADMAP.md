...
- `_guides/nola-group-new-orleans-vs-savannah-guide.md` — targets "new orleans vs savannah bachelorette" / "new orleans vs savannah group trip" — same comparison-query format as the existing Nashville/Charleston/Austin guides (both are go-to Southern historic-district bachelorette and girls-trip destinations organizers cross-shop): nightlife hours and open-container reality, food scene depth, large-group villa/rental inventory vs. Savannah's smaller short-term-rental market, walkability of the historic cores, and a verdict by trip type; checked `_guides/` — no Savannah comparison exists
