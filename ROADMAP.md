...
- `_guides/nola-group-rock-n-roll-marathon-guide.md` — targets "new orleans marathon group trip" / "rock n roll new orleans marathon travel guide" — the Rock 'n' Roll New Orleans Marathon (typically late February, inside the Feb–May peak season) draws runners plus a cheering-squad entourage with zero existing coverage anywhere on the site (confirmed via grep for "marathon"/"half marathon"/"5k"/"10k"); cover the runner-vs-spectator split within one group, race-morning road closures and transportation logistics, carb-load dinner and post-race recovery-day structure at a villa, and how race weekend overlaps with early Mardi Gras season crowds/lodging; category "Activities & Day Trips"

- `_guides/nola-group-new-orleans-vs-charlotte-guide.md` — targets "new orleans vs charlotte bachelorette" / "new orleans vs charlotte girls trip" — Charlotte is a common regional Southeast girls-trip/bachelorette alternative with no existing comparison page (confirmed via grep of `_guides/` for "charlotte"); cover uptown-Charlotte-brewery-and-rooftop-bar scene vs. live-music-city framing, lodging (Charlotte's hotel/short-term-rental market vs. New Orleans' purpose-built villa market), food and drink culture (New South/brewery vs. Creole-Cajun), and the "easy regional drive/short flight, unremarkable trip" vs. "flies-further, but it's the whole point" tradeoff; category "Planning & Logistics"
