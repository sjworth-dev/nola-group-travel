...
- `_guides/nola-group-zurich-classic-guide.md` — targets "zurich classic new orleans group tickets" / "pga tour new orleans group trip" — the Zurich Classic is a real annual PGA Tour stop at TPC Louisiana in Avondale, held in late April; only mentioned in passing (one bullet) in `_guides/festival-season-calendar.md`, no dedicated page; distinct from the existing `large-group-golf-guide.md` (which covers a group playing golf, not spectating a tour event) — a spectator-day guide (grounds tickets, hospitality areas, shuttle logistics, pairing it with the same week's other spring events); write generally on format and defer current-year tickets/pairings/pricing to official sources; category "Activities & Day Trips"

- `_guides/nola-group-celebration-in-the-oaks-guide.md` — targets "celebration in the oaks new orleans group" / "city park christmas lights new orleans group" — Celebration in the Oaks is a real annual holiday light display at City Park running through December, family-friendly and low-disruption per `_guides/festival-season-calendar.md` (currently only one bullet there); no dedicated page; a distinctive multigenerational-friendly December anchor the site undercovers; write generally on format/ticketing and defer current-year hours/pricing to official sources — do not assert a demand-tier claim for December, it isn't classified in the Seasonality section; category "Friends & Family"

- `_guides/nola-group-restaurant-week-guide.md` — targets "new orleans restaurant week group" / "nola restaurant week reservations for large groups" — New Orleans Restaurant Week is a real annual mid-January event (special reduced prix-fixe menus at top restaurants), landing inside January's soft/value-season lull per the Seasonality section; only mentioned in passing (one bullet) in `_guides/festival-season-calendar.md`, no dedicated page and not covered by `nola-group-landmark-restaurant-booking-guide.md` (which is about booking landmark restaurants generally, not this specific citywide prix-fixe event); write generally on format/reservation strategy and defer current-year participating restaurants/menus/prices to official sources; category "Food & Drink"

- `_guides/nola-group-new-orleans-vs-miami-guide.md` — targets "new orleans vs miami bachelorette" / "new orleans vs miami group trip" — same honest-comparison format as the existing Nashville/Charleston/Memphis/Savannah/Austin guides in `_guides/`; Miami is a common alternative-destination search for group organizers and isn't yet covered by any existing comparison guide; write on nightlife hours/style, food culture, villa vs. condo/hotel large-group lodging landscape, cost, and heat, deferring specific venue/price claims to general observation; category "Planning & Logistics"
