...
**Human-added page (Aug 20 2026, Sam):** `/guides/plan-a-group-trip/` — "How to Plan a Group Trip to New Orleans: Start Here". Target query: "how to plan a group trip to new orleans" + related early-stage planning searches (top-of-funnel per the strategy below). This is the site's planning cornerstone/hub: it sequences the trip decisions in order and links to the deep guides at each step. It is also linked from the homepage intro. During interlink passes, link TO this page from planning-adjacent guides where a natural sentence allows. Do not duplicate its step-by-step structure inside other guides; deep guides go deep, the hub sequences.
...
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-new-orleans-vs-savannah-guide.md` — best vs page (#5–6, ~56 impr/28d across both phrasing directions). Refresh dates/facts, tighten the verdict, make sure title/H2s read for both "new orleans vs savannah" AND "savannah vs new orleans", add a short bachelorette-verdict paragraph, cross-link the other top vs pages.
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-new-orleans-vs-chicago-guide.md` — #6–7, ~38 impr/28d. Same treatment as the Savannah page.
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-new-orleans-vs-charleston-guide.md` — #6.6–8.6, ~28 impr/28d. Same treatment.
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-new-orleans-vs-nashville-guide.md` — ranks #6 but only ~2 impr/28d. Nashville is the single biggest rival city for bachelorette groups, so impressions this low mean the page isn't matching how people actually phrase the choice ("nashville or new orleans", "new orleans or nashville which is better"). Rework title, intro, and H2s around the choice framing, with an explicit bachelorette verdict.
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-new-orleans-vs-las-vegas-guide.md` — #7.6, ~11 impr/28d. Same treatment as the Savannah page.
- [x] (done Aug 20 2026, by hand) `_guides/bachelor-party.md` — same deep-rebuild treatment as bachelorette (~90 impr/28d across variants, positions #24–49; itinerary/planner long-tail queries visible in GSC).
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-best-time-to-visit-guide.md` — ZERO impressions in 28d = effectively not ranking for "best time to visit new orleans" or any month query, on a pure top-of-funnel topic. Rebuild month-by-month with verdicts per the Seasonality section; front-load the search phrase in the title.
- [x] (done Aug 20 2026, by hand) `_neighborhoods/lakeview.md` — mid-funnel. #9.5 with 192 impr, nearly page 1. Refresh facts, add 3+ inline links to/from related guides (City Park, family-reunion, quiet-base themes).
- [x] (done Aug 20 2026, by hand) `_guides/nola-group-neighborhood-comparison-guide.md` — mid-funnel. #16.8, 79 impr. Refresh, and weave links to it from the individual neighborhood pages during their refreshes.
- [x] (done Aug 20 2026, by hand) `_guides/budget-guide.md` — mid-funnel. #8.1, 69 impr. Verify every number; freshness matters on cost content.
- [x] (done Aug 20 2026, by hand) `_guides/transportation-guide.md` — in-trip. "getting around new orleans" (#37.6, 40 impr). Restructure the intro and H2s around that exact phrase; verify streetcar fares and airport-transfer costs.
...
- Never edit or delete `robots.txt`, `llms.txt`, or `api/guides.json` — human-maintained machine-readability infrastructure. `api/guides.json` regenerates from front matter automatically; which links `llms.txt` curates is a human call.
