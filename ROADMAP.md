...
- `_guides/nola-group-event-space-rental-guide.md` — NEEDS RESCOPE OR SKIP (flagged 2026-07-22): the original framing (buyout bars, private dining, courtyards, rooftops, villa-vs-venue, budget, questions-to-ask, neighborhoods) is ~70% already covered by the existing `private-event-spaces-guide.md` (2026-05-31) and fails the "Not already covered" bar. The one genuinely uncovered angle is *corporate meeting/conference space* specifically — hotel ballrooms/meeting rooms, breakout space, AV, day-rate structure, all-day working-session F&B, and how a working meeting venue differs from both a room block and a party venue. If revived, rescope to that query ("meeting space rental new orleans corporate" / "conference space new orleans large group") and link out to private-event-spaces-guide.md rather than duplicating it; otherwise skip.
- `_guides/nola-group-new-orleans-vs-memphis-guide.md` — targets "new orleans vs memphis group trip" / "new orleans vs memphis bachelorette" — same comparison-query format as the Nashville/Charleston/Austin/Savannah guides; Memphis is the natural cross-shop for a music-first group (Beale Street's own open-container strip, blues/soul heritage, BBQ, Graceland day-trip pull) deciding between two Deep South music cities: compare music depth and originality, nightlife hours, food identity (BBQ vs. Creole/Cajun range), walkability of the entertainment cores, and large-group rental inventory, with a verdict by trip type; checked `_guides/` — no Memphis comparison exists

- `_guides/nola-group-white-linen-night-guide.md` — targets "white linen night new orleans group" / "white linen night warehouse district" — White Linen Night is a real, long-running annual early-August art walk on Julia Street in the Warehouse/Arts District (galleries open late, street party, everyone dressed in white to beat the heat); a natural big-group August evening that pairs with the soft-season value window; write generally on format/timing and defer exact date + gallery lineup to official sources per the no-invented-specifics rule; checked `_guides/` — no dedicated page (Warehouse District covered only as a lodging/venue neighborhood), category "Festivals & Events"

- `_guides/nola-group-running-of-the-bulls-guide.md` — targets "running of the bulls new orleans group" / "san fermin in nola" — the New Orleans Running of the Bulls (San Fermín in Nola) is a real annual mid-July event where roller-derby skaters with plastic bats stand in for the bulls through the CBD/Warehouse District, with an all-white-and-red dress code and big block parties bracketing the run; a distinctive July group activity sitting in the same soft-season-spike window as Tales of the Cocktail; write generally on format/what-to-expect and defer exact date/route to official sources; checked `_guides/` — no page exists, category "Festivals & Events"

- `_guides/nola-group-corporate-meeting-space-guide.md` — targets "meeting space rental new orleans corporate" / "conference space new orleans large group" — the genuinely-uncovered slice left after private-event-spaces-guide.md: working meeting/conference venues rather than party venues — hotel ballrooms and meeting rooms, breakout space, AV/screens, day-rate vs. F&B-minimum structure, all-day working-session catering, and how a working venue differs from both a room block and a private dining buyout; must link out to private-event-spaces-guide.md and the corporate-retreat guides rather than duplicating them; category "Corporate Retreats"

- `_guides/nola-group-wednesday-at-the-square-guide.md` — targets "wednesday at the square new orleans group" / "lafayette square concert series" — Wednesday at the Square is a real, free, long-running spring outdoor concert-and-food series in Lafayette Square (CBD), a low-cost weekday group anchor during the high-demand spring stretch; write generally on format/season and defer the current-year lineup/dates to official sources; checked `_guides/` — no dedicated page, category "Festivals & Events"
