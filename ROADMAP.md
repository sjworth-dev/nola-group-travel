...
- `_guides/nola-group-wine-food-experience-guide.md` — targets "new orleans wine and food experience group" / "NOWFE group trip" — the New Orleans Wine & Food Experience (NOWFE) is a real annual multi-day wine-and-food festival held across the city in mid-May, landing inside the spring high-demand stretch; only mentioned in passing (one bullet) in `_guides/festival-season-calendar.md`, no dedicated page; a distinctive tasting-format group anchor distinct from the site's existing cook-off/festival guides; write generally on format and defer current-year participating restaurants/dates to official sources; category "Food & Drink"

- `_guides/nola-group-film-festival-guide.md` — targets "new orleans film festival group trip" / "new orleans film festival tickets" — the New Orleans Film Festival is a real annual mid-October event (independent film screenings across multiple city venues), landing inside October's peak season; only mentioned in passing (one bullet) in `_guides/festival-season-calendar.md`, no dedicated page; distinct from the existing `nola-group-film-location-tour-guide.md` (which covers filming-location sightseeing, not festival attendance); write generally on format/venue-hopping logistics and defer current-year lineup/dates to official sources; category "Festivals & Events"
