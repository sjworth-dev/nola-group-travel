...
- `_guides/nola-group-freret-street-festival-guide.md` — targets "freret street festival new orleans" / "freret street festival group" — the Freret Street Festival is a real one-day neighborhood festival (typically May) centered on the Freret Street restaurant/bar corridor in Uptown; currently gets one solid paragraph in `_guides/nola-group-spring-crawfish-festival-season-guide.md` but no dedicated page with a group-planning checklist, itinerary tie-in, or large-group section; write generally on format and neighborhood context, defer current-year vendor/music lineup to official sources; category "Festivals & Events"

- `_guides/nola-group-mardi-gras-world-tour-guide.md` — targets "mardi gras world tour group" / "mardi gras world new orleans large group tour" — Mardi Gras World (the float-building warehouse on the riverfront) is a real, bookable, year-round group attraction; currently only namedropped as a location landmark in `_guides/nola-group-buku-music-festival-guide.md` and `_guides/nola-group-krewe-membership-guide.md`, with no dedicated page on visiting it as a group activity; write generally on tour format and group booking considerations, defer current-year hours/pricing to official sources; category "Activities & Day Trips"
