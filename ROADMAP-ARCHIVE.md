...
2026-07-24 12:00 UTC — content: add _guides/nola-group-running-of-the-bulls-guide.md — targets "running of the bulls new orleans group"/"san fermin in nola"; group planning guide for the New Orleans Running of the Bulls (roller-derby skaters swinging plastic bats stand in for the bulls through the CBD/Warehouse District, all-white-and-red dress code, mid-July block parties bracketing the run) framed as a near-ideal big-group July activity: the three-part day (opening/run/after-party), a runners-vs-spectators split table, the practical/heat case for the white-and-red dress code, the mid-July heat-and-timing reality per the Seasonality section (soft month with a local event-weekend spike, same as Tales of the Cocktail), street-closure transportation notes, a loose day-shape table, how it differs from the music festivals, pro tips, and the big-group accommodation section keyed to CBD/Warehouse District proximity with plain-example properties (Castleday, The Syd, Heirloom, Hotel Perle); 9 inline internal links (tales-of-the-cocktail-guide, open-container-law-guide, summer-trip-guide, charter-bus-guide, ride-share-master-guide, festival-season-calendar, day-drinking-vs-nightlife-guide, warehouse-district neighborhood, cbd neighborhood) plus the required /where-to-stay/ final CTA; deferred exact date/route/start-time to the official San Fermín in Nola site per the no-invented-specifics rule; removed the item from Up Next; backfilled Up Next with nola-group-red-dress-run-guide.md (real August Hash House Harriers red-dress charity pub-crawl, only an incidental mention in shoulder-season-guide.md, passes the Topic Selection Bar) to keep the backlog healthy
